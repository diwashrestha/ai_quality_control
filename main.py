...
if uploaded_file is not None:
    try:
        ...
        col2.header("Class 1 Defect")
        col2.image(Image.fromarray(inf_out_1[1]))
        

        col3, col4 = st.columns(2)
        col3.header("Class 3 Defect")
        col3.image(Image.fromarray(inf_out_3[1]))
        col4.header("Class 4 Defect")
        col4.image(Image.fromarray(inf_out_4[1]))
    ...
    image_deck = [
        "test_images/9b1abd245.jpg",
        "test_images/000f6bf48.jpg",
        "test_images/849d70baf.jpg",
        "test_images/000f6bf48.jpg",
        "test_images/6d56c7d91.jpg",
        "test_images/aeaa1deef.jpg",
        "test_images/1308a608d.jpg",
        "test_images/2ec10042f.jpg",
        "test_images/0d2a4e766.jpg",
        "test_images/904677cea.jpg",
        "test_images/edf12f5f1.jpg",
        "test_images/14cc1c6b0.jpg",
        "test_images/a2337ccb3.jpg",
        "test_images/06e6e7a8c.jpg",
        "test_images/31fdbb560.jpg"
        ]
    
    
    if st.button('Try'):
        # Randomly choose an image from the image deck
        image_number = random.randint(0,12) 
